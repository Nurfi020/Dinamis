...
interface AddRABItemModalProps {
  isOpen: boolean;
  onClose: () => void;
  rabId: string;
  onSave: (newItem: Omit<RABItem, 'id'>) => void;
}

export const AddRABItemModal: React.FC<AddRABItemModalProps> = ({
  isOpen,
  onClose,
  rabId,
  onSave,
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title="Tambah Item Pekerjaan RAB"
      subtitle="Input detail volume, harga material & upah tenaga kerja"
      maxWidth="lg"
    >
      <form onSubmit={handleSubmit} className="space-y-4 text-xs sm:text-sm">
        ...
        <div>
          ...
          <input
            ...
            placeholder="Contoh: Pasangan Dinding Bata Ringan tebal 10cm + Plester Aci"
            className={`w-full px-3 py-2 bg-white border rounded-lg text-xs sm:text-sm text-slate-900 placeholder-slate-400 focus:outline-none transition-all ${
              errors.itemName
        ...
        <div>
          ...
          <input
            ...
            placeholder="Contoh: Mortar Utama MU-380, Semen Padang"
